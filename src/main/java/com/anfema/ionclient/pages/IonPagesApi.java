...
public interface IonPagesApi
{
	...
	Observable<Response<PageResponse>> getPage( @Path("collection_identifier") String collectionIdentifier, @Path("page_identifier") String pageIdentifier, @Path("locale") String locale, @Query("variation") String variation, @Header("Authorization") String authorizationToken );
}
